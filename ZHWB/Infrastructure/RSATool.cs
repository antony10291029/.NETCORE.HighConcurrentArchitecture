...
namespace ZHWB.Infrastructure
{
    public class RSATool
    {
        ...
        public RSA PrivateKeyInstance
        {
            get {return _privateKeyRsaProvider;}
        }
        public RSA PublicKeyInstance
        {
            get {return _publicKeyRsaProvider;}
        }
        #region 使用私钥签名
        ...
        private RSA CreateRsaProviderFromPrivateKey(string privateKey)
        {
            ...
            this._privateKeyRsaProvider=rsa;
            return rsa;
        }
        ...
        private RSA CreateRsaProviderFromPublicKey(string publicKeyString)
        {
            ...
            using (MemoryStream mem = new MemoryStream(x509Key))
            {
                using (BinaryReader binr = new BinaryReader(mem))  //wrap Memory Stream with BinaryReader for easy reading
                {
                    ...
                    this._publicKeyRsaProvider=rsa;
                    return rsa;
                }
